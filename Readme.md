...
<img src="https://komarev.com/ghpvc/?username=Divyaraj-M&label=Profile%20views&color=0e75b6&style=flat" alt="profile views" />
...
`Roadmaps` · `PRDs & User Stories` · `Backlog Grooming` · `Sprint Planning` · `Agile/Scrum` · `Multi-role Workflows` · `Customer Journey Mapping`
...
`Cohort & Funnel Analysis` · `Adoption / Retention / Engagement` · `Cost-Benefit Thinking`
